...
ctrl_registry.add("PicoLightSparseCtrl", ".pico_light_sparse_ctrl")
ctrl_registry.add("PicoRetargetTrackingBfmCtrl", ".pico_retarget_tracking_bfm_ctrl")
ctrl_registry.add("WbTeleopNpzPlaybackCtrl", ".wbteleop_npz_playback_ctrl")
